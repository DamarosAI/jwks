...
> below are narrowed by it: the **canonical hero** is now *"The execution platform that makes
> sites trial-capable, then provable"*, and **decision 4 ("agentic" is canon)** is scoped to the
...
*(Superseded 2026-07-27 by ADR-0002: **The execution platform that makes sites trial-capable, then
