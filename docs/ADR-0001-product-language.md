# ADR-0001 - One product language

## Context

Extra named surfaces and AI identities obscured one clinical-execution system.

## Decision

Public product has five workflow steps:
...
Change requires matching accepted identity decision in Damaros implementation repository.
